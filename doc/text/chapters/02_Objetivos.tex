...
% Para que esto sea posible también se tratará el asunto de cómo obtener un almacén de datos operativo mediante CKAN, un sistema de gestión de datos que permite el almacenaminto y publicación de datos en distintos formatos.